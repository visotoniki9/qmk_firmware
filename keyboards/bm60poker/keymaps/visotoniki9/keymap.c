...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_qwerty] = LAYOUT_60_ansi(
        ...
        KC_LCTL,        KC_LGUI, KC_LALT,                            KC_SPACE,                           KC_RALT, KC_RCTL, MO(_fn), MO(_rgb)
    ),
    [_fn] = LAYOUT_60_ansi(
    ...
    [_rgb] = LAYOUT_60_ansi(
        ...
        _______,          RGB_M_P,  RGB_M_B, RGB_M_R, RGB_M_SW, _______, _______, _______, _______, _______, KC_UP,             _______,
        glowON,  glowOFF, _______,                              _______,                            KC_LEFT, KC_DOWN, KC_RIGHT, _______),
};
